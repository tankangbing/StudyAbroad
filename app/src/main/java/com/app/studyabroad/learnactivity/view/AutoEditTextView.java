package com.app.studyabroad.learnactivity.view;
...
public class AutoEditTextView extends android.support.v7.widget.AppCompatEditText  {
    ...
    private void initData(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        leftTextColor = typeArray.getColor(R.styleable.AutoEditTextView_leftTextColor, getColor(R.color.colorbrack_t));
        ...
        downLineDefaultColor = typeArray.getColor(R.styleable.AutoEditTextView_downLineDefaultColor, getColor(R.color.colorbrack_t));
        downLineFocusColor = typeArray.getColor(R.styleable.AutoEditTextView_downLineFocusColor, getColor(R.color.colorWhite));
        typeArray.recycle();
//        setBackground(null);
        initPaint();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //绘制底部的线
        if (isShowDownLine) {
            canvas.drawLine(getScrollX()+ dip2px(6), this.getHeight() - dip2px(6), getScrollX() + this.getWidth()- dip2px(6), this.getHeight() - dip2px(6), mLinePaint);
        }
    }
