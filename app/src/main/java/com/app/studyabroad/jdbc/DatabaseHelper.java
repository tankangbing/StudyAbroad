...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db)
    {
        ...
        sBuffer.append("CREATE TABLE [" + TABLE_NAME + "] (");//视频播放记录表
        ...
        sBuffer.append("CREATE TABLE [" + TABLE_NAME_RSA + "] (");
        sBuffer.append("[id] INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, "); //id
        ...
        //创建纪录用户密码的表
        sBuffer.delete(0,sBuffer.length());
        sBuffer.append("CREATE TABLE [" + TABLE_NAME_USER + "] (");
        sBuffer.append("[id] INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, "); //id
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion)
    {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_NAME_USER); //删除用户表
        onCreate(db);
